...
namespace TFTools.ToolBox.TextureTools.TextureCombiner
{
	...
	public class TB_TextureCombiner_Window : EditorWindow
	{
		...
		void ExportTexture ()
		{
			...
			NativeArray<Color> rChannel = new NativeArray<Color>(m_RChannelTexture.GetPixels(), Allocator.TempJob);
			NativeArray<Color> gChannel = new NativeArray<Color>(m_GChannelTexture.GetPixels(), Allocator.TempJob);
			NativeArray<Color> bChannel = new NativeArray<Color>(m_BChannelTexture.GetPixels(), Allocator.TempJob);
			NativeArray<Color> aChannel = new NativeArray<Color>(m_AChannelTexture.GetPixels(), Allocator.TempJob);
